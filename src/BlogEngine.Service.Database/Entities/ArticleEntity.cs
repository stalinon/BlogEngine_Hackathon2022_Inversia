...
/// </summary>
[Table("articles")]
internal sealed class ArticleEntity : BaseEntity, IHasEntityId
{
    /// <inheritdoc />
    [Key]
    [Column("id")]
    ...
    {
        modelBuilder.Entity<ArticleEntity>().HasIndex(x => x.UserInfoId).HasDatabaseName("IX_users_user_info_id").IsUnique();
